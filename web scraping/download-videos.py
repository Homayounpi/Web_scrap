...
class VideDownloadException(Exception):
    pass

class QualityError(VideDownloadException):
    pass
...
class Scraper:
    ...
    def get_all_links(self):
        ...
        video_links = content.find_all('a',href=re.compile(r'.mp4'))
...
class Main:
    ...
    def download(self):
        ...
        print('\nVideo downloaded')
s = Main('https://www.namasha.com/v/lk8ddKtK','144')
s.download()
# print(s.get_link())